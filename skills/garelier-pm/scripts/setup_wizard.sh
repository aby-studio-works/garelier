#!/usr/bin/env bash
#
# Garelier Setup Wizard (bash) — v2.6.3
#
# Three modes:
...
EOF
    ...
    echo "       git commit -m 'Garelier: initialize PM $PM_ID (v2.6.3)'"
    ...
    sed -i.bak \
        ...
        -e "s|^garelier_version = \"2.0.0\"|garelier_version = \"2.6.3\"|" \
        -e "s|^garelier_version = \"2.1.0\"|garelier_version = \"2.6.3\"|" \
        -e "s|^garelier_version = \"2.5.0\"|garelier_version = \"2.6.3\"|" \
        -e "s|^garelier_version = \"2.6.0\"|garelier_version = \"2.6.3\"|" \
        -e "s|^garelier_version = \"2.6.1\"|garelier_version = \"2.6.3\"|" \
        -e "s|^garelier_version = \"2.6.2\"|garelier_version = \"2.6.3\"|" \
        -e "s|^wizard_version = \"2.0.0\"|wizard_version = \"2.6.3\"|" \
        -e "s|^wizard_version = \"2.1.0\"|wizard_version = \"2.6.3\"|" \
        -e "s|^wizard_version = \"2.5.0\"|wizard_version = \"2.6.3\"|" \
        -e "s|^wizard_version = \"2.6.0\"|wizard_version = \"2.6.3\"|" \
        -e "s|^wizard_version = \"2.6.1\"|wizard_version = \"2.6.3\"|" \
        -e "s|^wizard_version = \"2.6.2\"|wizard_version = \"2.6.3\"|" \
        "$TOML"
    rm -f "$TOML.bak"
