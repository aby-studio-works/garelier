...
const shellScript = [
  "#!/usr/bin/env bash",
  "#",
  "# blueprint_ship.test.ts — pins blueprint_ship.ts's ship/abandon bookkeeping.",
  "#",
  ...
  "#",
  "# Self-contained: run directly (`bun test blueprint_ship.test.ts`) or from ci.ts.",
  "set -uo pipefail",
  "",
  "SELF_DIR=\"$(cd \"$(dirname \"$0\")\" && pwd)\"",
  "BS=\"$SELF_DIR/blueprint_ship.ts\"",
  "[ -f \"$BS\" ] || { echo \"blueprint_ship.test: cannot find blueprint_ship.ts next to me\" >&2; exit 1; }",
  "",
  "TMP=\"$(mktemp -d)\"",
  "trap 'rm -rf \"$TMP\"' EXIT",
  "GREL=\"__garelier\"",
  ...
  "  # === 1. shipped ===========================================================",
  "  R=\"$(fresh_repo case1)\"",
  "  OUT=\"$(bun \"$BS\" --project \"$R\" --pm-id acme --slug my-slug --outcome shipped --date 2026-07-05)\" \\",
  ...
  "  R2=\"$(fresh_repo case2)\"",
  "  bun \"$BS\" --project \"$R2\" --pm-id acme --slug my-slug --outcome shipped --dry-run >/dev/null \\",
  ...
  "  # === 3. abandoned -> Status archived ======================================",
  "  R3=\"$(fresh_repo case3)\"",
  "  bun \"$BS\" --project \"$R3\" --pm-id acme --slug my-slug --outcome abandoned --date 2026-07-05 >/dev/null \\",
  ...
  "  OUT4=\"$(bun \"$BS\" --project \"$R4\" --pm-id acme --slug my-slug --outcome shipped)\" \\",
...
test("blueprint_ship shell parity oracle", () => {
