...
| Lens Packs / role judgment focus | `skills/garelier-core/driver/src/lenses.ts`, `skills/garelier-core/templates/lenses/lens_registry.toml`, `skills/garelier-core/templates/lenses/*.toml`, DEC-086 | `docs/lens.md`, `docs/lens.ja.md` |
...
- Retired directory layouts (the pre-rename project-state docs location)
  must not resurface in shipped content; `ci.ts` lints for this.
